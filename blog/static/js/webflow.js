...
! function (t) {
		...
		var F = e.frame = function () {
			...
			I = f(function (e) {
				...
				e.init = function (e) {
					...
					L.backface && X.hideBackface && B(this.el, L.backface.css, "hidden")
			...
			N = f(function (t) {
				...
				t.init = function (t, e, n, r) {
					...
					}(e[2], this.ease, a), this.delay = u(e[3], this.delay, s), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = S.test(this.name), this.unit = r.unit || this.unit || X.defaultUnit, this.angle = r.angle || this.angle || X.defaultAngle, X.fallback || r.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + T + this.duration + "ms" + ("ease" != this.ease ? T + l[this.ease][0] : "") + (this.delay ? T + this.delay + "ms" : ""))
				}, t.set = function (t) {
			...
			R = f(N, function (t, e) {
				...
				t.init = function () {
					e.init.apply(this, arguments), this.current || (this.current = {}, J.perspective && X.perspective && (this.current.perspective = X.perspective, B(this.el, this.name, this.style(this.current)), this.redraw()))
				}, t.set = function (t) {
	...
	n(40), n(73), n(74), n(76), n(77), n(79), n(80), t.exports = n(81)
}, function (t, e, n) {
	"use strict";
	var i = n(0);
	...
	var i = n(1),
		...
		X = function (t) {
			var e = N[t] = k(L.prototype);
			return e._k = t, e
		},
		B = R && "symbol" == typeof L.iterator ? function (t) {
			return "symbol" == typeof t
		} : function (t) {
			return t instanceof L
		},
		G = function (t, e, n) {
			return t === q && G($, e, n), w(t), e = x(e, !0), w(n), r(N, e) ? (n.enumerable ? (r(t, F) && t[F][e] && (t[F][e] = !1), n = k(n, {
				enumerable: _(0, !1)
			})) : (r(t, F) || M(t, F, _(1, {})), t[F][e] = !0), H(t, e, n)) : M(t, e, n)
		},
		V = function (t, e) {
			w(t);
			for (var n, i = m(e = b(e)), r = 0, o = i.length; o > r;) G(t, n = i[r++], e[n]);
			return t
		},
		Y = function (t) {
			var e = I.call(this, t = x(t, !0));
			return !(this === q && r(N, t) && !r($, t)) && (!(e || !r(this, t) || !r(N, t) || r(this, F) && this[F][t]) || e)
		},
		J = function (t, e) {
			if (t = b(t), e = x(e, !0), t !== q || !r(N, e) || r($, e)) {
				var n = j(t, e);
				return !n || !r(N, e) || r(t, F) && t[F][e] || (n.enumerable = !0), n
			}
		},
		Q = function (t) {
			for (var e, n = A(b(t)), i = [], o = 0; n.length > o;) r(N, e = n[o++]) || e == F || e == u || i.push(e);
			return i
		},
		Z = function (t) {
			for (var e, n = t === q, i = A(n ? $ : b(t)), o = [], a = 0; i.length > a;) !r(N, e = i[a++]) || n && !r(q, e) || o.push(N[e]);
			return o
		};
	R || (s((L = function () {
		...
		var t = d(arguments.length > 0 ? arguments[0] : void 0),
			e = function (n) {
				this === q && e.call($, n), r(this, F) && r(this[F], t) && (this[F][t] = !1), H(this, t, _(1, n))
			};
		return o && U && H(q, t, {
			configurable: !0,
			set: e
		...
		return this._k
	}), S.f = J, T.f = G, n(37).f = O.f = Q, n(26).f = Y, n(36).f = Z, o && !n(9) && s(q, "propertyIsEnumerable", Y, !0), p.f = function (t) {
		return X(h(t))
	}), a(a.G + a.W + a.F * !R, {
		Symbol: L
	});
	...
	a(a.S + a.F * !R, "Symbol", {
		...
		stringify: function (t) {
			...
			if (n = e = i[1], (y(e) || void 0 !== t) && !B(t)) return g(e) || (e = function (t, e) {
	...
	i.define("forms", t.exports = function (t, e) {
		...
		function b(e, n) {
			...
			r.done = o.find("> .w-form-done"), r.fail = o.find("> .w-form-fail"), r.fileUploads = o.find(".w-file-upload"), r.fileUploads.each(function (e) {
				! function (e, n) {
					...
					if (g) f.on("click", function (t) {
						...
						v.on("click", function () {
							f.removeAttr("data-value"), f.val(""), m.html(""), o.toggle(!0), s.toggle(!1)
						}), f.on("change", function (r) {
							(i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), u.toggle(!1), a.toggle(!0), m.text(i.name), E() || _(n), n.fileUploads[e].uploading = !0, function (e, n) {
								var i = {
									name: e.name,
									size: e.size
								};
					...
					function O(t) {
						var i = t.responseJSON && t.responseJSON.msg,
							r = b;
						"string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = y : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = w), h.text(r), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), u.toggle(!0), n.fileUploads[e].uploading = !1, E() || x(n)
					}
			...
			r.handler = null, r.redirect = i.attr("data-redirect"), w.test(s) ? r.handler = S : s || (a ? r.handler = O : y())
		}
		...
		return r.ready = r.design = r.preview = function () {
			! function () {
				...
				o.each(b)
			}(), g || s || (s = !0, f.on("submit", h + " form", function (e) {
				var n = t.data(this, h);
	...
	i.define("navbar", t.exports = function (t, e) {
		...
		function _(n, r) {
			...
			}(u), u.el.off(p), u.button.off(p), u.menu.off(p), S(u), a ? (O(u), u.el.on("setting" + p, function (t) {
				return function (n, i) {
					i = i || {};
					var r = f.width();
	...
	i.define("slider", t.exports = function (t, e) {
		...
		function w(e, n) {
			...
			r.el.off(d), r.left.off(d), r.right.off(d), r.nav.off(d), y(r), o ? (r.el.on("setting" + d, O(r)), k(r), r.hasTimer = !1) : (r.el.on("swipe" + d, O(r)), r.left.on("tap" + d, x(r)), r.right.on("tap" + d, _(r)), r.config.autoplay && !r.hasTimer && (r.hasTimer = !0, r.timerCount = 1, function t(e) {
				k(e);
				var n = e.config;
				var i = n.timerMax;
			...
			}(r))), r.nav.on("tap" + d, "> div", O(r)), l || r.mask.contents().filter(function () {
		...
		function S(e, n) {
			...
			var l = e.offsetX || 0,
				...
				_ = "opacity " + b + "ms " + y,
				k = "transform " + b + "ms " + y;
			if (o || (v.each(p.intro), g.each(p.outro)), n.immediate && !s) return c(v).set(h), void T();
			if (e.index !== e.previous) {
				if ("cross" === w) {
					var O = Math.round(b - b * i.crossOver),
						S = Math.round(b - O);
					return _ = "opacity " + O + "ms " + y, c(m).set({
						visibility: ""
					}).add(_).start({
						opacity: 0
					}), void c(v).set({
